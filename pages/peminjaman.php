                                ...
                                <div class="container">
                                    <div class="panel panel-container">
                                        <div class="bootstrap-table">
                                            <a href="peminjaman_aksi.php?aksi=tambah" class="btn btn-primary">TAMBAH
                                                DATA</a>
                                            <hr>
...
?>
                                                        <tr>
                                                            ...
                                                            <td class="text-center"><?php echo $data['genre']; ?></td>
                                                            <td class="text-center">
                                                                <?php 
                                                            ...
                                                            <td class="text-center">
                                                                <a href="peminjaman_proses.php?id=<?php echo $data['id']; ?>&proses=kembalikan"
